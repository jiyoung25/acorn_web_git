...
<body>
	...
	<div id="carouselExampleIndicators" class="container carousel slide" data-bs-ride="true">
	  ...
	  <div class="carousel-inner">
	    ...
	    <div class="carousel-item">
	      <img src="https://cdn.pixabay.com/photo/2015/06/02/12/59/book-794978_960_720.jpg" class="d-block w-100" alt="...">
	    </div>
	  </div>
	...
	<%-- /include/footer.jsp 페이지를 포함시켜서 이 부분은 footer.jsp페이지가 응답하도록 한다. --%>
