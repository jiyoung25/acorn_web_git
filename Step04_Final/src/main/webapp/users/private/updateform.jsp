...
<body>
	...
	<div class="container">
		...
		<form action="update.jsp" method="post">
			...
			<div class="mb-3 row">
				<label class="col-sm-1 col-form-label" for="id">아이디</label>
				<div class="col-sm-11">
					<input type="text" id="id" value="<%=dto.getId() %>" disabled />
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-1 col-form-label" for="email">이메일</label>
				<div class="col-sm-11">
					<input type="text" id="email" name="email" value="<%=dto.getEmail() %>" />
				</div>
			</div>
			<button class="btn btn-secondary" type="submit">수정확인</button>
