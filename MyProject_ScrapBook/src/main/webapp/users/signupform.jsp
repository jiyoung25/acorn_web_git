...
<body>
	<div class="container">
		...
		<form action="signup.jsp" mehthod="post" id="signupForm" v-on:submit="onSubmit">
			...
			<div class="mb-2">
				...
				<input class="form-control" v-bind:class="{'is-valid':isNickValid, 'is-invalid':!isNickValid && isNickDirty}" v-on:input="inputNick" v-model ="nickname" type="text" name="nickname" id="nickname" v-bind:disabled="!isIdValid"	/>
	...
	let app = new Vue({
		...
		computed:{
			isFormValid(){
				let result = this.isIdValid && this.isNickValid && this.isPwdValid && this.isEmailValid;
				return result;
			}
		},
		methods:{
			inputId(e){
				...
				const regId = /^[a-z][a-zA-Z0-9_\-]{4,9}$/;
